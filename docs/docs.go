...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "http://www.forseer.com",
            "email": "forseerbussiness@gmail.com"
        },
        "license": {
            "name": "Apache 2.0",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/store.Portfolio"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreatePortfolioPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/portfolios/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search term for portfolio name",
                        "name": "name",
                        "in": "query",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdatePortfolioPayload"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateStockPayload"
                        }
                    }
                ],
                "responses": {
